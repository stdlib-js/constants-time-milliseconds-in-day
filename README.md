...
```javascript
MILLISECONDS_IN_DAY = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-milliseconds-in-day@v0.0.8-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-milliseconds-in-day@v0.0.8-umd/browser.js"></script>
```

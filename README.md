...
```javascript
MILLISECONDS_IN_DAY = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-milliseconds-in-day@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-milliseconds-in-day@umd/bundle.js"></script>
```
